...
<style>
        ...
        .col-md-4{
          margin-top: 40px; /* sesuaikan dengan tinggi navbar Anda */
        }
        .col-md-5{
        ...
        <div class="col-md-5">
            ...
            <div class="col-md-3">
                <div class="input-group flex-nowrap">
                    <button class="input-group-text btn-cokelat-muda" id="addon-wrapping" onclick="kurang()">-</button>
                    <input type="number" class="form-control-sm form-control" value="0" style="width:50px;" placeholder="number" aria-label="Username" aria-describedby="addon-wrapping" id="jumlah">
...
<div class="container">
    <br>
    <h5 class="text-dark-brown">Rekomendasi :</h5>
    <br>
    <div class="row">
      ...
      <div class="col-md-3 mb-4">
          ...
          <div class="card-body justify-content-center">
            ...
            <a href="/product/detail/{{$barang->id}}" class="btn btn-sm btn-cokelat col-md-5 text-nunito">Lihat Produk</a>
          </div>  
            </center>  
          </div>
      </div>
    ...
    <div class="col">
        <center>
            <a href="/client/menu" class="btn btn-cokelat col-md-4 btn-sm">Tampilkan Lebih Banyak</a>
        </center>
    </div>
</div>
<br>
