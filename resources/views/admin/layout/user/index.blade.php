    ...
    <div class="col border-0 shadow responsive-testimonial">
        <div class="card mb-3 border-0 shadow" >
          <div class="row g-0">
            ...
            <img 
            src="{{ asset($users->image ? 'storage/' . $users->image : 'img/user.png') }}"     
            alt="Foto Profil"     
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                          <form method="POST" action="/admin/backend/user/delete/{{$users->id}}">
                            @csrf
                            @method('DELETE')
                            <button type="submit" style="width:100%;" onclick="return confirm('Apa anda ingin menghapus data ini ?')"class="btn-sm btn-danger col btn w-100 col">Delete</button>
                          </form>
                        </div>
                    </div>                        
                    @endif
