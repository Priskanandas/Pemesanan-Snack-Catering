        ...
        <div class="row">            
            ...
            <div class="col-md-5 mb-3">
               <div class="container bg-light shadow" style="border-radius:5px;">
                <br>
                <h6 class="text-roboto fw-bold">Info Pembayaran</h6>
<p class="text-darker-brown" style="text-align: justify;">
  Noted: <br>
  - Isi catatan dengan nomor WA, alamat, request menu dan permintaan tambahan. Free ongkir untuk jarak maksimal 6 km.<br>
  - Nomor rekening ada di menu Tentang, dan info lebih lanjut dapat dihubungi melalui kontak di menu yang sama.<br>
  - Pemesanan maksimal H-1. Pesanan di hari yang sama mungkin akan ditolak jika permintaan terlalu banyak.<br>
  - Untuk pemesanan menu paket, perhatikan deskripsi produk untuk spesifikasi dan ketentuan request menu.<br>
  - Apabila tidak menuliskan produk, pesanan akan dibuatkan secara acak.<br>
  - Gunakan kode transaksi untuk pengambilan pesanan.
</p>
                    ...
                    @endif
                        ...
                        <div class="col">
                          <input type="text" name="DeskripsiPemesanan" id="DeskripsiPemesanan" placeholder="Catatan Pemesanan :" class="col form-control-sm form-control mb-3">
                        </div>
                        <div class="col">
                          <select name="metodePembayaran" id="metodePembayaran" class="form-control form-control-sm col mb-3" v-model="metodePembayaran">
                              ...
                              <option value="virtual">Transfer Bank</option>
                          </select>
                        </div>
                        <div class="col">
                          <select name="pengambilan" id="pengambilan" class="form-control form-control-sm col mb-3">
                              ...
                              <option value="kasir">Ambil Ditempat</option>
                              <option value="drive">Delivery Order</option>
                          </select>
                        </div>
                        <p>Tanggal Pengambilan</p>
                        <div class="col">
                            <input type="datetime-local" name="TanggalPengambilan" id="TanggalPengambilan" class="form-control form-control-sm col mb-3" >
                        </div>
                        <div class="col" v-if="metodePembayaran =='virtual'">
                        <p>Bukti Transfer</p>
                            <input type="text" name="bukti" id="bukti" class="form-control form-control-sm col mb-3" onfocus="this.type='file'" placeholder="BRI : 6849 0100 6321 535 a/n PUDI HARTOMO ">
                        </div>
                        <div class="col">
                            <button type="submit" class="col btn btn-sm btn-cokelat w-100">Proses Check Out </button>
                        </div>
                        <br>
                    </form>
               </div>
