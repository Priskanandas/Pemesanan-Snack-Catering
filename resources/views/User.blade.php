...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-5ThwJ7BO0nrXgFZGJnH2ORPt+imtI2Zjy/0n5Yr4kwwiDIXvEBK50uCNq2n4SU1F3R6t+g8xwCc3fZRYZWih2Q==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body class="bg-light-cream text-nunito">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark-brown text-nunito">
        <div class="container">
            <a class="navbar-brand" href="/client/home">Surya Catering</a>
            ...
            <div class="collapse navbar-collapse" id="mob-navbar">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0 mx-auto">
                    ...
                    <li class="nav-item hover-menu ms-2">
                        <a class="fas fa-shopping-cart" style="color:white; margin-top: 12px; font-size: 20px;" href="/client/cart/" aria-current="page"></a>
                    </li>
                    @auth
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle align-items-center hidden-arrow text-light nav-link" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          <img class="rounded-circle" style="object-fit:cover;" src="@if (Auth::user()->image && Auth::user()->image != 'img/user.png')
